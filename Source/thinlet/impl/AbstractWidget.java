...
import thinlet.ScrollableWidget;
import thinlet.ToolTipOwner;
...
public void setPopupMenuWidget(PopupMenuElement newpopup)
{
	...
	if (newpopup != null)
	{
		...
		popupmenuWidget.setParent(new ElementContainer<PopupMenuElement>()
			{
				public Iterator<PopupMenuElement> iterator()
...
public void paint(WidgetRenderer renderer)
{ paint((LwjglWidgetRenderer) renderer); }
...
protected void paintScrollableContent(LwjglWidgetRenderer renderer, boolean isenabled)
{
	throw new UnsupportedOperationException();
}
