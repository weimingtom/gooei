...
/**
 * Abstract parent of {@link MenuBarWidget} and {@link PopupWidget}, that
...
public PopupWidget popupMenu()
{
	...
	popup = new PopupWidget(desktop, (MenuContainerElement<?>) selected);
