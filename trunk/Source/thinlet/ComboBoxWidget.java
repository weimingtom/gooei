...
public final class ComboBoxWidget extends TextFieldWidget implements DataWidget<ComboBoxItem>, IconWidget, PopupOwner
{
...
public Dimension getPreferredSize()
{
	...
	if (isEditable())
	{
		Dimension size = super.getFieldSize();
		if (icon != null)
		{
	...
	else
	{
		...
		Dimension size = desktop.getSize(this, 4 , 4);
		...
		{ // no content nor items, set text height
			TLFont customfont = getFont(desktop.getDefaultFont());
			TLFontMetrics fm = desktop.getFontMetrics(customfont);
