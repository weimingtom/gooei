...
public class PanelWidget extends AbstractContainerWidget<Widget> implements IconWidget, ScrollableWidget
{
...
public Dimension getPreferredSize()
{
	...
	Dimension size = desktop.getSize(this, 0, 0);
	// add border size
	...
	{ // bordered panel
		...
		size.width = 0; // title width is clipped
	// add paddings
	size.width += getLeft() + getRight();
	size.height += getTop() + getBottom();
