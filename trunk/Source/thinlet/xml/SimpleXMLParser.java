...
private static Object createWidget(ThinletDesktop desktop, String classname)
{
...
{
	Object child = createWidget(desktop, name);
			...
			if (c == '<')
			{
				...
				{ // start or standalone tag
					...
					{ // tagname is available
						...
						current = (current != null) ? addElement(current, tagname) : createWidget(desktop, tagname);
					}
					text.setLength(0);
					while (true)
					{ // read attributes
